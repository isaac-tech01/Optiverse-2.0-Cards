      ...
      <View className={"flex-1" + topMargin}>
        ...
        <View className="mx-6">
          ...
          <View className="flex flex-col mb-6">
            <Text className="mb-2 text-sm font-semibold">Bank</Text>
          ...
          {/* Account Number */}
          <View className="flex flex-col mb-6">
            <Text className="mb-2 text-sm font-semibold">Account number</Text>
            <TextInput
...
export default AddBeneficiary2Screen;
